...
$(".close-link").click(function () {
 ...
 checkboxClass: "icheckbox_flat-green", radioClass: "iradio_flat-green" }
    ...
    $("table input").on("ifUnchecked", function () {
        ...
        checkState = "",
            $(this).parent().parent().parent().removeClass("selected"), countChecked()
    }
);
...
function countChecked() {
    ...
    var e = $(".bulk_action input[name='table_records']:checked").length; e ? ($(".column-title").hide(), $(".bulk-actions").show(), $(".action-cnt").html(e + " Records Selected")) : ($(".column-title").show(), $(".bulk-actions").hide())
}
...
$(document).ready(function () {
 ...
 NProgress.done() }
        ...
        var originalLeave = $.fn.popover.Constructor.prototype.leave; function gd(e, a, t) {
 return new Date(e, a - 1, t).getTime() }
 function init_flot_chart() {
 if (void 0 !== $.plot) {
 console.log("init_flot_chart"); for (var e = [[gd(2012, 1, 1), 17], [gd(2012, 1, 2), 74], [gd(2012, 1, 3), 6], [gd(2012, 1, 4), 39], [gd(2012, 1, 5), 20], [gd(2012, 1, 6), 85], [gd(2012, 1, 7), 7]], a = [[gd(2012, 1, 1), 82], [gd(2012, 1, 2), 23], [gd(2012, 1, 3), 66], [gd(2012, 1, 4), 9], [gd(2012, 1, 5), 119], [gd(2012, 1, 6), 6], [gd(2012, 1, 7), 9]], t = [], o = 0; o < 30; o++)t.push([new Date(Date.today().add(o).days()).getTime(), Math.floor(21 * Math.random()) + 20 + o + o + 10]); var n = {
 grid: {
...
, legend: {
 position: "ne", margin: [0, -25], noColumns: 0, labelBoxBorderColor: null, labelFormatter: function (e, a) {
 return e + "&nbsp;&nbsp;" }
, width: 40, height: 1 }
...
, borderColor: {
 ...
 console.log("init_skycons"); var e, a = new Skycons({
 color: "#73879C" }
), t = ["clear-day", "clear-night", "partly-cloudy-day", "partly-cloudy-night", "cloudy", "rain", "sleet", "snow", "wind", "fog"]; for (e = t.length; e--;)a.set(t[e], t[e]); a.play() }
 }
...
; $(".canvasDoughnut").each(function () {
 ...
 console.log("init_gauge [" + $(".gauge-chart").length + "]"), console.log("init_gauge"); var e = {
...
, barColor: "#26B99A" }
 ...
 console.log("init_autocomplete"); var e = $.map({
...
; try {
 ...
 function a(e, a) {
 var t = ""; "unsupported-file-type" === e ? t = "Unsupported format " + a : console.log("error uploading file", e, a), $('<div class="alert"> <button type="button" class="close" data-dismiss="alert">&times;</button><strong>File upload error</strong> ' + t + " </div>").prependTo("#alerts") }
 void 0 !== $.fn.wysiwyg && (console.log("init_wysiwyg"), $(".editor-wrapper").each(function () {
 var e = $(this).attr("id"); $(this).wysiwyg({
 toolbarSelector: '[data-target="#' + e + '"]', fileUploadError: a }
) }
), window.prettyPrint, prettyPrint()) }
 function init_cropper() {
 if (void 0 !== $.fn.cropper) {
 console.log("init_cropper"); var i = $("#image"), n = $("#download"), a = $("#dataX"), t = $("#dataY"), o = $("#dataHeight"), r = $("#dataWidth"), l = $("#dataRotate"), s = $("#dataScaleX"), c = $("#dataScaleY"), d = {
...
, "zoom.cropper": function (e) {
 ...
 var e, a, t = $(this), o = t.attr("name"), n = t.prop("type"); i.data("cropper") && ("checkbox" === n ? (d[o] = t.prop("checked"), e = i.cropper("getCropBoxData"), a = i.cropper("getCanvasData"), d.built = function () {
 i.cropper("setCropBoxData", e), i.cropper("setCanvasData", a) }
) : "radio" === n && (d[o] = t.val()), i.cropper("destroy").cropper(d)) }
), $(".docs-buttons").on("click", "[data-method]", function () {
 var e, a, t = $(this), o = t.data(); if (!t.prop("disabled") && !t.hasClass("disabled") && i.data("cropper") && o.method) {
 if (void 0 !== (o = $.extend({
}
, o)).target && (e = $(o.target), void 0 === o.option)) try {
 ...
 case "scaleX": case "scaleY": $(this).data("option", -o.option); break; case "getCroppedCanvas": a && ($("#getCroppedCanvasModal").modal().find(".modal-body").html(a), n.hasClass("disabled") || n.attr("href", a.toDataURL())) }
if ($.isPlainObject(a) && e) try {
 ...
 case 37: e.preventDefault(), i.cropper("move", -1, 0); break; case 38: e.preventDefault(), i.cropper("move", 0, -1); break; case 39: e.preventDefault(), i.cropper("move", 1, 0); break; case 40: e.preventDefault(), i.cropper("move", 0, 1) }
 }
); var u, m = $("#inputImage"), p = window.URL || window.webkitURL; p ? m.change(function () {
 var e, a = this.files; i.data("cropper") && a && a.length && (e = a[0], /^image\/\w+$/.test(e.type) ? (u = p.createObjectURL(e), i.one("built.cropper", function () {
 p.revokeObjectURL(u) }
...
, draw: function () {
 ...
 this.cursorExt = .3; var e, a = this.arc(this.cv); return this.g.lineWidth = this.lineWidth, this.o.displayPrevious && (e = this.arc(this.v), this.g.beginPath(), this.g.strokeStyle = this.pColor, this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, e.s, e.e, e.d), this.g.stroke()), this.g.beginPath(), this.g.strokeStyle = this.o.fgColor, this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, a.s, a.e, a.d), this.g.stroke(), this.g.lineWidth = 2, this.g.beginPath(), this.g.strokeStyle = this.o.fgColor, this.g.arc(this.xy, this.xy, this.radius - this.lineWidth + 1 + 2 * this.lineWidth / 3, 0, 2 * Math.PI, !1), this.g.stroke(), !1 }
 }
 }
); var e, a = 0, t = 0, o = 0, n = $("div.idir"), i = $("div.ival"); $("input.infinite").knob({
 ...
 console.log("init_daterangepicker"); function e(e, a, t) {
...
; $("#reportrange span").html(moment().subtract(29, "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#reportrange").daterangepicker(a, e), $("#reportrange").on("show.daterangepicker", function () {
 ...
 if (void 0 !== $.fn.daterangepicker) {
 console.log("init_daterangepicker_right"); function e(e, a, t) {
...
, CustomTabs = function (e) {
 ...
 e.preventDefault(); var a = $(this), t = "#" + a.parents(".notifications").data("tabbed_notifications"), o = a.closest("li").siblings().children("a"), n = a.attr("href"); o.removeClass("active"), a.addClass("active"), $(t).children("div").hide(), $(n).show() }
) }
, CustomTabs(); var a = idname = ""; $(document).on("click", ".notification_close", function (e) {
 ...
 easing: "easeOutElastic", delay: 3e3, barColor: "#26B99A", trackColor: "#fff", scaleColor: !1, lineWidth: 20, trackWidth: 16, lineCap: "butt", onStep: function (e, a, t) {
 $(this.el).find(".percent").text(Math.round(t)) }
 }
); var e = window.chart = $(".chart").data("easyPieChart"); $(".js_update").on("click", function () {
 e.update(200 * Math.random() - 100) }
); var n = $.fn.popover.Constructor.prototype.leave; $.fn.popover.Constructor.prototype.leave = function (e) {
 var a, t, o = e instanceof this.constructor ? e : $(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type); n.call(this, e), e.currentTarget && (a = $(e.currentTarget).siblings(".popover"), t = o.timeout, a.one("mouseenter", function () {
...
,
        ...
        if ($("#lineChartNetwork").length) {

            var e = document.getElementById("lineChartNetwork");
            new Chart(e, {

                type: "line",
                data: {

                    labels: ["14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00", "18:30", "19:00"],
                    datasets: [
                        {
                            ...
                            pointHoverBackgroundColor: "#fff",
                            pointHoverBorderColor: "rgba(220,220,220,1)",
                            pointBorderWidth: 1, data: [350, 350, 300, 310, 450, 350, 350, 350, 350, 350, 350]
                        }
,
                        {
                            ...
                            pointHoverBackgroundColor: "#fff",
                            pointHoverBorderColor: "rgba(151,187,205,1)",
                            pointBorderWidth: 1, data: [550, 550, 550, 550, 550, 550, 550, 550, 550, 550, 550]
                        }
]
                }
...
, new Chart(e, {
 ...
 console.log("init_calendar"); var o, e = new Date, a = e.getDate(), t = e.getMonth(), n = e.getFullYear(), i = $("#calendar").fullCalendar({
 header: {
 left: "prev,next today", center: "title", right: "month,agendaWeek,agendaDay,listMonth" }
, selectable: !0, selectHelper: !0, select: function (e, a, t) {
 $("#fc_create").click(), o = e, ended = a, $(".antosubmit").on("click", function () {
 var e = $("#title").val(); return a && (ended = a), $("#event_type").val(), e && i.fullCalendar("renderEvent", {
...
(), $("#datatable").dataTable(), $("#datatable-keytable").DataTable({
 ...
 fixedHeader: !0 }
); var e = $("#datatable-checkbox"); e.dataTable({
...
, {
 ...
 function init_echarts() {
    ...
    if ("undefined" != typeof echarts) {
        ...
        console.log("init_echarts"); var e = {
...
, detail: {
 show: !0, backgroundColor: "rgba(0,0,0,0)", borderWidth: 0, borderColor: "#ccc", width: 100, height: 40, offsetCenter: ["-60%", 10], formatter: "{value}%", textStyle: { color: "auto", fontSize: 30 } }
, data: [{
...
, series: [{
 name: "1", type: "pie", clockWise: !1, radius: [105, 130], itemStyle: a, data: [{
 value: 68, name: "68%Something #1" }
, {
 value: 32, name: "invisible", itemStyle: t }
] }
, {
 name: "2", type: "pie", clockWise: !1, radius: [80, 105], itemStyle: a, data: [{
 value: 29, name: "29%Something #2" }
, {
 value: 71, name: "invisible", itemStyle: t }
] }
, {
 name: "3", type: "pie", clockWise: !1, radius: [25, 80], itemStyle: a, data: [{
...
if ($("#echart_world_map").length) echarts.init(document.getElementById("echart_world_map"), e).setOption({
 title: {
  ...
  tooltip: { 
    trigger: "item", formatter: function (e) { 
        var a = (e.value + "").split("."); return a = a[0].replace(/(\d{1,3})(?=(?:\d{3})+(?!\d))/g, "$1,") + "." + a[1], e.seriesName + "<br/>" + e.name + " : " + a 
    }
 }, 
 toolbox: {
    show: !0, 
...
, { name: "Zimbabwe", value: 13076.978 }
 ...
 var a, t, o = e instanceof this.constructor ? e : $(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type); originalLeave.call(this, e), e.currentTarget && (a = $(e.currentTarget).siblings(".popover"), t = o.timeout, a.one("mouseenter", function () {
     clearTimeout(t), 
